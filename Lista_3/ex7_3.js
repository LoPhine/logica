...
var perg = rs.question("Escolha A ou B: ").toUpperCase(0)

if(perg == "A"){
    console.log("Progrma encerrado!")
}while(perg == "B"){
    var n1 = rs.questionInt("Digite um número: ")
    var n2 = rs.questionInt("Digite outro número número: ")
    console.log(n1 + n2)
    perg = rs.question("Escolha A ou B: ").toUpperCase(0)
